          ...
          <div class="p-6">
            ...
            <div class="mt-6">
              @if (!$user->payment_id)
                <a href="{{route('form.verify', ['token' => $user->token_num])}}"
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 3a1 1 0 0 1 1 1v1.055a7 7 0 1 1-2 0V4a1 1 0 0 1 1-1Zm0 6a5 5 0 1 0 0 10 5 5 0 0 0 0-10Z"/>
                  </svg>
              ...
              @else
                <button disabled
                        class="w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg
                               bg-green-600 text-white font-medium shadow-md cursor-not-allowed">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div class="text-center rounded-2xl border border-dashed border-slate-300 bg-white p-10">
            <div class="mx-auto h-12 w-12 rounded-full bg-indigo-50 flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-indigo-600" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2a7 7 0 0 0-7 7v2.126A2 2 0 0 1 4.553 12H5v6a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3v-6h.447A2 2 0 0 1 21 11.126V9a7 7 0 0 0-7-7Z"/>
              </svg>
            </div>
            <h3 class="mt-4 text-base font-semibold text-slate-900">No student data</h3>
            <p class="mt-1 text-sm text-slate-600">Once your details are available, they will appear here.</p>
          </div>
        </div>
      @endforelse
    </div>
